ALTER TABLE "chat_members" ADD COLUMN "last_read_at" timestamp;--> statement-breakpoint
ALTER TABLE "chats" ADD COLUMN "last_message_at" timestamp;--> statement-breakpoint
ALTER TABLE "chats" ADD COLUMN "last_message_preview" varchar(255);--> statement-breakpoint
